      ...
      <el-col :md="{span:span, offset: offset}">
        <el-form-item
          ...
          <el-input
            ...
            :autofocus="true"
            v-model="form[prop].line_1"
            auto-complete="off"/>
          <el-input
            v-else
            :autofocus="true"
            v-model="form[getFormatedLabel('line_1', true)]"
            auto-complete="off"/>
        </el-form-item>
      </el-col>
      <el-col :md="span">
        <el-form-item
          :label="getFormatedLabel('Address Line 2')"
          :prop="prop ? prop + '.line_2' : 'line_2'"
          size="small">
          <el-input
            v-if="prop && prefixProp"
            :autofocus="true"
            v-model="form[prop].line_2"
            auto-complete="off"/>
          <el-input
            v-else
            :autofocus="true"
            v-model="form[getFormatedLabel('line_2', true)]"
            auto-complete="off"/>
        </el-form-item>
      </el-col>
    </el-row>
      ...
      <el-col :md="{span:span, offset: offset}">
        <el-form-item
          ...
          <el-input
            v-if="prop && prefixProp"
            :autofocus="true"
            v-model="form[prop].town"
            auto-complete="off"/>
          <el-input
            v-else
            :autofocus="true"
            v-model="form[getFormatedLabel('town', true)]"
            auto-complete="off"/>
        </el-form-item>
      </el-col>
      <el-col :md="span">
        <el-form-item
          ...
          <el-input
            v-if="prop && prefixProp"
            :autofocus="true"
            v-model="form[prop].county"
            auto-complete="off"/>
          <el-input
            v-else
            :autofocus="true"
            v-model="form[getFormatedLabel('county', true)]"
            auto-complete="off"/>
        </el-form-item>
      </el-col>
    </el-row>
      ...
      <el-col :md="{span:span, offset: offset}">
        <el-form-item
          ...
          <el-input
            v-if="prop && prefixProp"
            :autofocus="true"
            v-model="form[prop].postcode"
            auto-complete="off"/>
          <el-input
            v-else
            :autofocus="true"
            v-model="form[getFormatedLabel('postcode', true)]"
            auto-complete="off"/>
        </el-form-item>
      </el-col>
      <el-col :md="span">
        <el-form-item
          ...
          <el-input
            v-if="prop && prefixProp"
            :autofocus="true"
            v-model="form[prop].country"
            auto-complete="off"/>
          <el-input
            v-else
            :autofocus="true"
            v-model="form[getFormatedLabel('country', true)]"
            auto-complete="off"/>
        </el-form-item>
      </el-col>
    </el-row>
