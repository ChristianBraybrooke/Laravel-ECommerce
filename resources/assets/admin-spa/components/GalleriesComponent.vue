    ...
    <div style="margin-bottom: 20px;">
      ...
      <el-popover
        ...
        <el-form
          ...
          <el-form-item
            ref="createGalleryName"
            prop="name">
            <el-input
              v-model="createGalleryForm.name"
              placeholder="Gallery Name"/>
          </el-form-item>
          <el-form-item>
            <el-button
              type="primary"
              @click="createGallery">Create</el-button>
          </el-form-item>
        </el-form>
      ...
      <el-button
        ...
        type="info"
        plain
        @click="getGalleries"><i class="el-icon-refresh"/></el-button>
      <el-button
        v-popover:addGalleryPopover
        v-if="!inModal"
        size="small"
        type="primary"
        plain
        @click="addGalleryPopoverVisible = true">Create New Gallery</el-button>
    </div>
    ...
    <el-popover
      ...
      <div style="text-align: right; margin: 0">
        <el-button
          size="mini"
          type="text"
          @click="deleteGalleryPopoverVisible = false">cancel</el-button>
        <el-button
          type="primary"
          size="mini"
          @click="deleteGalleryPopoverVisible = false">confirm</el-button>
      </div>
    </el-popover>
    ...
    <el-tabs
      ...
      <el-tab-pane
        ...
        <gallery-component
          ...
          @fileUnHighlighted="handleFileUnHighlighted"
          @fileHighlighted="handleFileHighlighted"
          @fileUploadSuccess="handleFileUploadSuccess"
          @fileUploadError="handleFileUploadError"
          @mediaSearch="handleMediaSearch"/>
      </el-tab-pane>
    </el-tabs>
