    ...
    <product-page-layout
      ...
      <template
        ...
        <el-row type="flex">
          <el-col :span="4">
            <el-form-item
              v-if="props.productForm.live_at"
              label="Live"
              prop="live_at.live"
              size="small">
              <el-switch
                v-model="props.productForm.live_at.live"
                active-color="#13ce66"
          ...
          <el-col :span="4">
            <el-form-item
              ...
              size="small">
              <el-switch
                v-model="props.productForm.list_in_shop"
                active-color="#13ce66"
                inactive-color="#ff4949"/>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item
              ...
              size="small">
              <el-switch
                v-model="props.productForm.featured"
                active-color="#13ce66"
                inactive-color="#ff4949"/>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col
            ...
            <el-form-item
              ...
              <el-input
                :autofocus="true"
                v-model="props.productForm.name"/>
            </el-form-item>
          </el-col>
          <el-col
            :lg="12"
        ...
        <el-row
          v-if="props.productForm.content"
          :gutter="20">
          <el-col :span="24">
            <content-component
              v-if="props.productForm.content"
        ...
        <el-row :gutter="20">
          <el-col
            ...
            :xs="24">
            <el-form-item
              v-if="props.productForm.collections && collections"
              :label="collection.name"
              :prop="'collections.data.collection_types_sync' + [collection.id - 1]"
              size="small">
              <el-select
                v-model="props.productForm.collections.data.collection_types_sync[collection.id]"
                ...
                placeholder="Select">
                <el-option
                  v-for="type in collection.types.data"
                  :key="type.name"
                  :label="type.name"
                  :value="type.id"/>
              </el-select>
