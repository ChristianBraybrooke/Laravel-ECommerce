                ...
                <el-form label-position="top"
                    ...
                    <el-tabs v-model="currentTab" type="border-card">
                        <el-tab-pane name="basic">
                            <router-link slot="label" :to="{ name: 'products.view' }">Basic Information</router-link>
                        ...
                        <el-tab-pane name="pricing">
                            <span slot="label"><router-link :to="{ name: 'products.view.pricing' }">Pricing</router-link></span>
