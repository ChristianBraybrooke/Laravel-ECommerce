<template lang="html">
  ...
  <div v-loading="loading">
      ...
      <el-form label-position="top" ref="orderForm" :model="order" @submit.native.prevent>
          ...
          <el-row :gutter="20" v-if="order.needs_address === 'Needs Address'">
              <el-col :md="12">
              ...
              <el-col :md="12">
                  ...
                  <address-form v-if="!order.use_billing_for_shipping" :form="order.shipping_address" prop="shipping_address"></address-form>
              </el-col>
          </el-row>
      </el-form>
      ...
      <el-row :gutter="20" style="margin-top: 40px;">
          <el-col :md="{span:24}">
              <el-button @click="processSubmit()" type="primary">Create Estimate</el-button>
          </el-col>
      </el-row>
