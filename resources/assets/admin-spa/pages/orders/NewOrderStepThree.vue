<template lang="html">
  <div v-loading="loading">
    ...
    <ul>
      <li
        v-for="(total, key) in orderTotals"
        :key="key"><strong>{{ total.total }}</strong> {{ shopData.currency }}{{ total.value }}</li>
    </ul>
    ...
    <el-form
      ...
      <payment-form
        ...
        :starting-amount="orderTotal"
        :on-payment-processed="onPaymentProcessed"/>
