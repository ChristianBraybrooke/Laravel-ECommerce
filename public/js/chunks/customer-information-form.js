...
exports.default = {
  ...
  methods: {
    ...
    handleCustomerSelect: function handleCustomerSelect(customer) {
      ...
      this.form.billing_address = _extends({}, customer.billing_address, this.form.billing_address);

      this.form.shipping_address = _extends({}, customer.shipping_address, this.form.shipping_address);
    }
  }
};
