...
exports.default = {
    ...
    components: {
        ContentInner: function ContentInner() {
            return __webpack_require__.e/* import() */(51).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/ContentInner.vue"));
        }
    },
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        if (this.objectHas(ecommerceConfig, 'aditional_cols.' + this.tableOptions.typeNamePlural)) {
            forEach(ecommerceConfig.aditional_cols[this.tableOptions.typeNamePlural], function (col) {
                var col_index = findIndex(_this.mergedTableOptions.collumns, ['prop', col.prop]);
                ...
                if (col_index === -1) {
                    _this.mergedTableOptions.collumns.push(col);
                } else {
                    _this.mergedTableOptions.collumns[col_index] = col;
                }
            });
        }
    },
        ...
        createData: function createData() {
            ...
            this.$refs.createForm.validate(function (valid) {
                if (valid) {
                    ...
                    _this2.createFormData.with = _this2.requestWith;
                    _this2.createFormData.include = _this2.requestIncludes;

                    _apiService2.default.persist('post', {
                        path: _this2.baseUrl ? _this2.baseUrl : _this2.typeName,
                        object: _this2.createFormData
                    }).then(function (data) {
                        this.addModel(data);
                        this.dialogVisible = false;
