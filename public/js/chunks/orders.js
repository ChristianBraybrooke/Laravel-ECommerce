    ...
    methods: {
        ...
        addObject: function addObject() {
            ...
            this.$refs['form'].validate(function (valid, errors) {
                if (valid) {
                    _this3.additions.push(_this3.model);
                    _this3.onAdditionAdded(_this3.model, _this3.total);
                    _this3.$emit('addition-added', _this3.model, _this3.total);
                    _this3.model = {};
        ...
        addition: function addition() {
            ...
            return h(
                "addition-form",
                {
                    ...
                    on: {
                        "addition-added": function additionAdded(model, total) {
                            return addition_total = total;
                        }
                    }
                },
                [function (props) {
...
exports.default = {
    ...
    components: {
        ...
        ProductTable: function ProductTable() {
            return __webpack_require__.e/* import() */(37).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/ProductTable.vue"));
        }
    },
                                ...
                                'payments',
                                {
                                    ...
                                    on: {
                                        'payment-processed': function paymentProcessed(payment) {
                                            return _this3.paymentAdded(row, payment);
                                        }
                                    }
                                },
                                [function (props) {
...
exports.default = {
    ...
    components: {
        ...
        ContentComponent: function ContentComponent() {
            return __webpack_require__.e/* import() */(36).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/ContentComponent.vue"));
        },
        ProductForm: function ProductForm() {
            return __webpack_require__.e/* import() */(35).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/ProductForm.vue"));
        }
          ...
          _c("div", { attrs: { slot: "reference" }, slot: "reference" }, [
            _c("strong", [
              _vm._v(
                _vm._s(_vm.amountPrefix) +
                  _vm._s(
                    _vm.formatAmount ? _vm.formatPrice(_vm.total) : _vm.total
                  )
              )
            ])
          ])
