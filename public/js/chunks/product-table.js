...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_components_product_form_SelectInputFormField__ = __webpack_require__("./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_components_product_form_SelectInputFormField___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_components_product_form_SelectInputFormField__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_components_product_form_TextFormField__ = __webpack_require__("./resources/assets/admin-spa/components/product-form/TextFormField.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_components_product_form_TextFormField___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_components_product_form_TextFormField__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_components_product_form_TextareaFormField__ = __webpack_require__("./resources/assets/admin-spa/components/product-form/TextareaFormField.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_components_product_form_TextareaFormField___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_components_product_form_TextareaFormField__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_components_product_form_DynamicFormField__ = __webpack_require__("./resources/assets/admin-spa/components/product-form/DynamicFormField.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_components_product_form_DynamicFormField___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_components_product_form_DynamicFormField__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_lodash_orderby__ = __webpack_require__("./node_modules/lodash.orderby/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_lodash_clone__ = __webpack_require__("./node_modules/lodash.clone/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_lodash_clone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_lodash_clone__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_lodash_range__ = __webpack_require__("./node_modules/lodash.range/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_lodash_range___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_lodash_range__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_lodash_foreach__ = __webpack_require__("./node_modules/lodash.foreach/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_lodash_foreach___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_lodash_foreach__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    SelectInputFormField: __WEBPACK_IMPORTED_MODULE_6_components_product_form_SelectInputFormField___default.a,
    TextFormField: __WEBPACK_IMPORTED_MODULE_7_components_product_form_TextFormField___default.a,
    TextareaFormField: __WEBPACK_IMPORTED_MODULE_8_components_product_form_TextareaFormField___default.a,
    DynamicFormField: __WEBPACK_IMPORTED_MODULE_9_components_product_form_DynamicFormField___default.a
  },
  props: {
    button: {
      type: Object,
  ...
  computed: _objectSpread({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapGetters"])(['shopData']), {
    orderedFormSections: function orderedFormSections() {
      return __WEBPACK_IMPORTED_MODULE_10_lodash_orderby___default()(this.customisationForm.product.order_form.sections.data, 'order');
    },
    quantityRange: function quantityRange() {
      return __WEBPACK_IMPORTED_MODULE_12_lodash_range___default()(1, 250);
    },
  ...
  methods: {
    ...
    setCustomisationProduct: function setCustomisationProduct(val) {
      ...
      this.clonedPrice = __WEBPACK_IMPORTED_MODULE_11_lodash_clone___default()(product.price);
    ...
    handleEditPrice: function handleEditPrice() {
      if (this.editPrice) {
        this.customisationForm.product.price = __WEBPACK_IMPORTED_MODULE_11_lodash_clone___default()(this.clonedPrice);
      }
    ...
    formattedPrices: function formattedPrices(product) {
      ...
      if (product.options) {
        __WEBPACK_IMPORTED_MODULE_13_lodash_foreach___default()(product.options, function (option) {
          if (option) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    console.log('ProductTable.vue Mounted'); // this.shipping_rate = this.order.cart.totals.Shipping;
  ...
  methods: {
      ...
      if (row.options) {
        ...
        forEach(row.options, function (value, key) {
          ...
          if (newValue) {
            ...
            } else if (_typeof(value) === 'object' && value.value && value.name) {
    ...
    itemRowActionsFormatter: function itemRowActionsFormatter(row, column, cellValue) {
      ...
      return h("span", [h("new-product-form", {
        "attrs": {
          "edit-form": true,
          "table-index": this.order.items.indexOf(row),
          "product": row,
          "button": {
            text: 'Edit Product',
            size: 'mini'
    ...
    shippingRowFormatter: function shippingRowFormatter(value) {
      ...
      }, [options]) : this.formatPrice(this.order.cart.totals.Shipping, this.shopData.currency);
    },
    discountRowFormatter: function discountRowFormatter(value) {
      ...
      }, [options]) : "".concat(this.order.cart.totals.Discount, "%");
    },
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-295edac9\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-295edac9\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-295edac9", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-295edac9\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("26062894", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-295edac9\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SelectInputFormField.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-295edac9\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SelectInputFormField.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"@babel/preset-env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"]},\"forceAllTransforms\":true}]],\"plugins\":[\"@babel/plugin-proposal-object-rest-spread\",[\"@babel/plugin-transform-runtime\",{\"helpers\":false}]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-295edac9\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/admin-spa/components/product-form/SelectInputFormField.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = injectStyle
...
Component.options.__file = "resources/assets/admin-spa/components/product-form/SelectInputFormField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-295edac9", Component.options)
  } else {
    hotAPI.reload("data-v-295edac9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
