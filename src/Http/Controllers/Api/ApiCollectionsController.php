...
class ApiCollectionsController extends Controller
{
    ...
    {
        $this->authorize('create', get_class($collection));
    ...
    public function update(CollectionRequest $request, Collection $collection)
    {
        ...
        $live = $request->filled('live_at.live') ? ($request->live_at['live'] ? Carbon::now()->subMinute()->toDateTimeString() : null) : optional($collection->live_at['carbon'])->toDateTimeString();
    ...
    {
        $this->authorize('bulkUpdate', get_class(new Collection()));
