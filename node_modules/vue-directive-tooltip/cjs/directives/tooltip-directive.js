...
function filterBindings(binding) {
    var delay = isNaN(binding.value.delay) ? _tooltip2.default._defaults.delay : binding.value.delay;
    ...
    return {
        ...
        offset: binding.value.offset || _tooltip2.default._defaults.offset,
        delay: delay
    };
}
